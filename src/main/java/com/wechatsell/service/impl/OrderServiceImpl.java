...
import com.wechatsell.converter.OrderMasterToOrderDTOConverter;
...
import com.wechatsell.repository.OrderDetailRepository;
import com.wechatsell.repository.OrderMasterRepository;
import com.wechatsell.service.OrderService;
import com.wechatsell.service.ProductService;
import com.wechatsell.util.KeyUtil;
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        for (OrderDetail orderDetail : orderDTO.getOrderDetailList()) {
            ...
            orderAmount = productInfo.getProductPrice().
                    ...
                    .add(orderAmount);
            //订单详情入库
            BeanUtils.copyProperties(productInfo,orderDetail);//属性拷贝null也拷贝，所以先拷贝再修改
        ...
        BeanUtils.copyProperties(orderDTO,orderMaster);//属性拷贝null也拷贝，所以先拷贝再修改
